...
For technical debt, Sonar issues, "deuda técnica", "recuperá la deuda", exclusions, or suppressions, READ and FOLLOW the full instructions in `.github/sonarremedy-instructions.md` (in this repo).
